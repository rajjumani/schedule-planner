...
<div class="row">
	<div class="col-xs-12">
		...
		<form class="form-horizontal" role="form" name="centreform" method="post">
						...
						<div class="form-group">
							<label class="col-sm-3 control-label no-padding-right" for="form-field-1">BSC Name: </label>
...
<?php
	...
	if(isset($_POST['sewadar_name'])&&!empty($_POST['sewadar_name'])){ 
		...
		$result = $db_handle->executeUpdate("UPDATE `".$master."` set bsc = '".$sewadar_name."' WHERE centre_name = '".$centre_name."' AND date = '".$date."' AND col =".$col);
