		...
		<div class="col-xs-12">
			<!-- PAGE CONTENT BEGINS -->
				...
				<?php
					...
					if (isset($_GET['id'])) {
						$sewadar_list = $db_handle->runQuery("SELECT * FROM `bsk` WHERE id = ".$_GET['id']);
...
<?php
	if(isset($_POST['Submit'])){
		...
		if(isset($_POST['sewadar_name'])&&!empty($_POST['sewadar_name'])){
			...
			$result = $db_handle->executeUpdate("UPDATE `bsk` set name = '".$_POST['sewadar_name']."', mob = '".$_POST['mob']."' WHERE  id=".$id);
		}
	}
